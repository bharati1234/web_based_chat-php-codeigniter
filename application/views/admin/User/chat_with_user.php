    ...
    <div class="row">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
          ...
          <h1 class="h2">chat with <?php echo $User['username'];
                                    ?>
          </h1>
        </div>
                ...
                <div class="col-md-6">
                  <div class="card card-bordered">
                    ...
                    <div class="ps-container ps-theme-default ps-active-y" id="chat-content" style="overflow-y: scroll !important; height:400px !important;">
                      ...
                      <div class="media media-chat "> <img class="avatar" src="https://img.icons8.com/color/36/000000/administrator-male.png" alt="...">
                        <div class="media-body">
                          ...
                          ?>
                            <?php if ($sessionuid['user_id'] == $message['from_user_id']) {

                            ?>
                              <p class="meta" style="color:blue;"><time datetime="2018"><?php echo $message['from_username']; ?></time></p>
                            <?php } else {
                            ?>
                              <p class="meta" style="color:red;"><time datetime="2018"><?php echo $message['from_username']; ?></time></p>
                            <?php } ?>

                            <p><?php echo $message['chat_message']; ?></p>

                            <p class="meta"><time datetime="2018"><?php echo $message['timestamp'];
                                                                  ?></time></p>
                      ...
                      <!-- <div class="media media-chat media-chat-reverse">
                        <div class="media-body">
                          <?php foreach ($messages_sent as $sent_messages) : ?>
                            <p>
                              <?php echo $sent_messages['chat_message'];
                              ?>
                            </p>
                            <p class="meta"><time datetime="2018"><?php echo $sent_messages['timestamp'];
                                                                  ?></time></p>
                          <?php endforeach ?>
                    ...
                    <div class="publisher bt-1 border-light"> <img class="avatar avatar-xs" src="https://img.icons8.com/color/36/000000/administrator-male.png" alt="...">
                      <input class="publisher-input" type="text" placeholder="Write something" name="message_to_send" id="message_to_send">
